...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    (function () {
        ...
        let currentAlbumArtUrl = null;      albumArtInput.addEventListener('change',
            (event) => {
...
inputIds.title.addEventListener('input',
    ...
    async function activPageMode(btn, page) {
        ...
        switch (page) {
            case convertPageEl:
                openConvertBtn.style.display = 'flex';                playerMusic.classList.add('hidden');
                break;
            default:               convertPageEl.classList.remove('active');
