...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function resetActivityEdit() {
        try {
            ...
            audioProgres.style.background = '';
            [durationPG,
                cutEndTimes].forEach(e => e.textContent = formatTime(0));
            duresult.forEach(e =>
        ...
        try {
            ...
            const loadAudio = new Promise((resolve, reject) => {
                ...
                cutAudioPlayer.onloadedmetadata = async () => {
                    ...
                    [durationPG,
                        cutEndTimes].forEach(e => e.textContent = formatTime(d));
    ...
    (function () {
        ...
        function ensureExt(calc) {
            ...
            Object.keys(isEnsure).forEach(key =>
                isEnsure[key] = false);
        }
    ...
    const oqrn = document.querySelector("#generateQrBtn");
        ...
        filterBtn.addEventListener('click', (e) => {
            e.stopPropagation(); navigation(); hideFilter();
        });
